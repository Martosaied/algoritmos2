...
void test_ej1(vector<int> (*qr)(vector<int>)) {
  EXPECT_EQ(v2s((*qr)(vector<int>())), set<int>());
  EXPECT_EQ(v2s((*qr)(vector<int>({1, 1, 1, 1, 1}))), set<int>{1});
  EXPECT_EQ(v2s((*qr)(vector<int>({1, 1, 2, 2, 3, 3}))), set<int>({1, 2, 3}));
  EXPECT_EQ(v2s((*qr)(vector<int>({1, 1, 2, 3, 3}))), set<int>({1, 2, 3}));
}
...
TEST(Ej, 08) {
  ...
  map<int, set<int>> r2 = agrupar_por_unidades(vector<int>({1, 2, 3, 1}));
  map<int, set<int>> e2 = map<int, set<int>>({{1, set<int>{1}}, {2, set<int>{2}}, {3, set<int>{3}}});
  EXPECT_EQ(r2, e2);

  map<int, set<int>> r3 = agrupar_por_unidades(vector<int>({1, 2, 3, 1, 12}));
  map<int, set<int>> e3 = map<int, set<int>>({{1, set<int>{1}}, {2, set<int>{2, 12}}, {3, set<int>{3}}});
  EXPECT_EQ(r3, e3);

  map<int, set<int>> r4 = agrupar_por_unidades(vector<int>({1, 2, 3, 1, 12, 20}));
  map<int, set<int>> e4 = map<int, set<int>>({{1, set<int>{1}}, {2, set<int>{2, 12}}, {0, set<int>{20}},
                                              {3, set<int>{3}}});
  EXPECT_EQ(r4, e4);

  map<int, set<int>> r5 = agrupar_por_unidades(vector<int>({1, 2, 3, 1, 12, 20, 1101}));
